...
class Student(models.Model):
    ...
    address = models.CharField(max_length=100, default='Update')
    email = models.EmailField(default='Update')
    phone = PhoneField(blank=True, help_text='Contact phone number', default='Update')
    pph = PhoneField(blank=True, help_text='Contact phone number', default='Update')
    father_name = models.CharField(max_length=20, null=True, default='Update')
    mother_name = models.CharField(max_length=20, null=True, default='Update')
...
class Assign(models.Model):
    ...
    def __str__(self):
        ...
        cr = Course.objects.get(id=self.course_shortname)
...
class Sem(models.Model):
    ...
    select_subject = models.ForeignKey(Course, on_delete=models.CASCADE)
    sem_class = models.ForeignKey(Class, on_delete=models.CASCADE, related_name="CS5A")
    def __str__(self):
        return  self.year_sem


class SemStudentCourse(models.Model):
    student = models.ForeignKey(Student, on_delete=models.CASCADE)
...
class SemMarks(models.Model):
    student_sem = models.ForeignKey(SemStudentCourse, on_delete=models.CASCADE)
