...
#testing
    path('t_Dashboard/', views.t_Dashboard, name='dashboard'),
    path('t_Dashboard/t_profile', views.t_profile, name='t_profile'),
    path('student/<slug:stud_id>/semester', views.test, name='semester'),
    path('student/<slug:stud_id>/<sem>/sem', views.sem, name='sem'),
    path('student/profile', views.profile, name='profile'),
    path('teacher/<int:assign_id>/Students/Semesters/', views.stud_In, name='stud_In'),
    path('teacher/Students/<slug:stud_id>/Semesters/', views.t_sem_details, name='t_sem_details'),
    path('teacher/<slug:stud_id>/<sem>/semester', views.sub, name='sub'),
]